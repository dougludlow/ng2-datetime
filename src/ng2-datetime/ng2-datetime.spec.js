...
describe('ng2-datetime', function () {
    ...
    describe('datepicker', function () {
        ...
        it('should update ngModel/datepicker when the input changes', testing_1.fakeAsync(function () {
            var fixture = testing_1.TestBed.createComponent(DatePickerComponent);
            var component = getComponent(fixture, ng2_datetime_1.NKDatetime);
            tickAndDetect(fixture, 2);
            var element = fixture.debugElement.query(platform_browser_1.By.css('.date input')).nativeElement;
...
function tickAndDetect(fixture, times) {
